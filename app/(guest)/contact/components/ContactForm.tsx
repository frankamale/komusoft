  ...
  return (
    <motion.div {...fadeUp(0.1)}
      ...
      <form className="space-y-5">
        ...
        <div>
          <label htmlFor='service' className="block text-xs font-bold uppercase tracking-wider mb-2 text-gray-500">Service Interested In</label>
          <select id="service" name="service" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#05ADEE] focus:border-transparent transition-all text-gray-700">

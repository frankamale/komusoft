...
export function Hero() {
    return (
        <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-linear-to-br from-[#0A0947] via-[#0e1552] to-[#0A0947] pt-20">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                            ...
                            <span className="text-white/90 text-sm">Enterprise-Grade Software Solutions</span>
                        </div>
                    ...
                    <div className="relative">
                        <div className="relative z-10">
                            <Image
                                ...
                                className="rounded-2xl shadow-2xl shadow-[#05ADEE]/20"
                                width={800}
                                height={600}
                            />

                            <div className="absolute -top-6 -left-6 p-4 bg-white rounded-xl shadow-2xl backdrop-blur-sm">
                                <Code2 className="w-8 h-8 text-[#05ADEE]" />
                                <div className="mt-2 text-sm font-semibold text-gray-800">Mobile Apps</div>
                            </div>
